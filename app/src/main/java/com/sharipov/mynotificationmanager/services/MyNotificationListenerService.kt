    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        try {
            ...
            coroutineScope.launch {
                ...
                else if (excludedApp.isExcluded) {
                    saveNotification(sbn, notificationDao, context, coroutineScope)
                }
            }
        } catch (e: Exception) {
            e.printStackTrace()
...
//    val groupUserName = getGroupAndUserName(extras, appName)
//    val group = groupUserName.first
//    val user =groupUserName.second
